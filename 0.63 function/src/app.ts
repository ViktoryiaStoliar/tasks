...
// [1, 2, 1, 2, 3, 4, 5, 1] -> 3
// {
//     const arr: string[] = ['1', '2', '1', '2', '3', '4', '5', '1'];

//     function countDubl(arr: string[]) {
//         let o = {}
//         for (let i = 0; i < arr.length; i++) {
//             if (o[arr[i]]) {
//                 o[arr[i]] += 1
